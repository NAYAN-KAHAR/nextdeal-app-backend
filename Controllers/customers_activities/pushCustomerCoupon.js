...
const CustomerRedeemCoupon = async (req, res) => {
  try {
    const {couponName, customer_mobile, coupon_id, shopkeeper_mobile,
         discount, discountType, spendingAmount } = req.body;
    
        console.log(req.body);

    if (!couponName || !customer_mobile || !coupon_id || !shopkeeper_mobile 
